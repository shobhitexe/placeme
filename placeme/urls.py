...
from base.views import index_view,login_handle_view,student_cred_view,company_view,profile_view,academics_view,createform_view,placement_applications_view
